...
const envSchema = z.object({
  ...
  CORS_ORIGINS: z
    .string()
    .default("https://medialane.io,https://www.medialane.io,https://dapp.medialane.io,https://api.medialane.io,https://services.medialane.io,https://mediolano.app,http://localhost:3000"),
